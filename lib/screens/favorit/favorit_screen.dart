// lib/screens/favorit/favorit_screen.dart
...
class _FavoritScreenState extends State<FavoritScreen> {
  ...
  Future<void> fetchFavorit() async {
    try {
      ...
      final List<Resep> list =
          (response as List)
              .map<Resep>((item) => Resep.fromJson(item['resep']))
              .toList();
      ...
      debugPrint('Gagal ambil resep favorit: $e');
      setState(() => isLoading = false);
      showErrorSnackbar('Gagal ambil resep favorit: $e');
    }
  }
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap:
                          () => Get.to(() => ResepDetailScreen(resep: resep)),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _bottomIcon(Icons.favorite, onTap: () {}, isActive: true),
        ],
      ),
    );
  }
